...
export default function Skills() {
  ...
  const skills = {
    technical: [
      ...
      { name: "Bootstrap", prof: 65 },
      { name: "Tailwind", prof: 90 },
      { name: "Html,css", prof: 89 },
      { name: "Nodejs", prof: 50 },
      { name: "Wordpress", prof: 95 },
    ],
    soft: [
      { name: "Communication", prof: 90 },
      { name: "Leadership", prof: 85 },
      { name: "Creativity", prof: 95 },
      { name: "Team Player", prof: 89 },
      { name: "Time Management", prof: 90 },
      { name: "Adaptible", prof: 90 },
    ],
  };
  ...
  return (
    <div
      id="Skills"
      className="min-h-screen w-full bg-gradient-to-r from-white to-gray-60 py-10"
    >
